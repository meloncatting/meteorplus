...
public class HudEditorScreen extends WidgetScreen implements Snapper.Container {
    private static final Color SPLIT_LINES_COLOR = new Color(70, 119, 255, 55);

    private static final Color INACTIVE_BG_COLOR = new Color(252, 65, 48, 40);
    private static final Color INACTIVE_OL_COLOR = new Color(252, 65, 48, 175);

    private static final Color HOVER_BG_COLOR = new Color(70, 119, 255, 30);
    private static final Color HOVER_OL_COLOR = new Color(70, 119, 255, 165);

    private static final Color SELECTION_BG_COLOR = new Color(70, 119, 255, 18);
    private static final Color SELECTION_OL_COLOR = new Color(70, 119, 255, 80);
